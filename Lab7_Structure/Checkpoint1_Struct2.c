...
int main() {
	...
	person std2 = {"Peter Wong", 19, {12, 8, 89}, 3.50};
	person std3 = {};
	...
	printf("\n\nList all students \n");
	printf("-----------------------------------------------------\n");
	printf("%3s %-30s %s %-6s %-4s\n","No.","Name","Age","Birthday","GPA");
	...
	printf(" 3. %-30s %d %02d/%02d/%02d %.2f\n",std3.name,std3.age,std3.bday.day,std3.bday.month,std3.bday.year,std3.gpa);
	printf("-----------------------------------------------------\n");
	system("PAUSE");
	return 0;
}
